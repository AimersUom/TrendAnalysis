...
ps = PorterStemmer()
with codecs.open('F:/4th year project/all-the-news (2)/keywordsnew.csv', "r", encoding="utf-8",
    ...
    for row in reader:
        ...
        s= 0.0
        y = (9.6724* tfintopic) + (1.0159 * tfincontent) + (0.1130* noOfpublishers) + (0.0002 * noOfarticles) + (-0.0157 * dategap)
        s = 1 / (1 + math.exp(-y))
        print("y= "+str(y))
        ...
        def displayResult(result):
            ...
            if __name__ == '__main__':
                ...
                root.geometry("300x300")# Define the size of the UI
        ...
        sql = "INSERT INTO calculatinglogisticvalue(id,keyword,sigmoidvalue,svmResult)" \
              " VALUES (%s, %s, %s, %s)"
